...
while True:
    ...
    if timer_elapsed == 1: # This is executed at 1kHz
        ...
        if CL != 1: # Buck-OL Open loop so just limit the current but otherwise pass through the reference directly as a duty cycle
            ...
            p_err_int = saturate(p_err_int, 2500, 0) # saturate the integral error
            p_pi_out = (10*p_err)+(30*p_err_int)
            ...
            i_err_int = saturate(i_err_int, 250, 0) # saturate the integral error
